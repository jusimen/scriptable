...
// icon-color: yellow; icon-glyph: times-circle;
...
const settings = Object.freeze({
	...
	resources: {
		validations:
			'https://api.carrismetropolitana.pt/v2/metrics/videowall/sla',
	},
});
		...
		return {
			primary_value:
				validationsData.data[
					`_${type}_simple_three_events_or_simple_one_validation_transaction_fail_until_now`
				],
			...
			secondary_value:
				validationsData.data[
					`_${type}_simple_three_events_or_simple_one_validation_transaction_fail_until_now`
				] / validationsData.data[`_${type}_scheduled_rides_until_now`],
