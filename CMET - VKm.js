...
// icon-color: yellow; icon-glyph: ruler-horizontal;
...
const settings = Object.freeze({
	...
	resources: {
		validations:
			'https://api.carrismetropolitana.pt/v2/metrics/videowall/vkm',
	},
});
		...
		return {
			primary_value:
				validationsData.data[
					`_${type}_simple_three_events_or_simple_one_validation_transaction_vkm_until_now`
				],
			...
			secondary_value:
				validationsData.data[
					`_${type}_simple_three_events_or_simple_one_validation_transaction_vkm_until_now`
				] / validationsData.data[`_${type}_scheduled_vkm_until_now`],
